...
def test_insert_character(chars) -> None:
    ...
    """
    character_id = db.characters.insert_character(chars[0])
    assert character_id == 1
    character_id = db.characters.insert_character(chars[1])
...
def test_select_character(chars) -> None:
    ...
    """
    character_id = db.characters.insert_character(chars[0])
    character = db.characters.select_character(character_id)
...
def test_select_characters(chars) -> None:
    ...
    """
    db.characters.insert_character(chars[0])
    db.characters.insert_character(chars[1])
    characters = db.characters.select_characters()
